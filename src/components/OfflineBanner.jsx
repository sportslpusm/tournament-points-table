...
export default function OfflineBanner({ darkMode }) {
  ...
  return (
    <div className={`px-4 py-2.5 text-center text-xs font-semibold animate-slideUp ${
      darkMode
        ? 'bg-amber-500/10 text-amber-400 border-b border-amber-500/20 backdrop-blur-xl'
        : 'bg-amber-50 text-amber-700 border-b border-amber-200/80'
    }`}>
